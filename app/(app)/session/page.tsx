...
function SessionView() {
  ...
  if (screen === "card") {
    ...
    return (
      <div
        className="relative min-h-[100dvh] bg-bg w-full max-w-md desk:max-w-[600px] mx-auto overflow-hidden pt-safe md:border-x md:border-border desk:border-x-0"
  ...
  // ---- CHAT SCREEN ----
  return (
    <div className="bg-bg w-full max-w-md desk:max-w-[880px] mx-auto flex flex-col pt-safe md:border-x md:border-border desk:border-x-0" style={{ height: "100dvh" }}>
      {/* Chat header */}
